...
class DetailedLabReportWiz(models.TransientModel):
    _name = 'detailed.lab.report.wizard'
    _description = 'Detailed Lab Report Wizard'
    ...
    def action_xlsx(self):
        ...
        worksheet.merge_range('C2:D2', "Detailed Lab Report", cell_text_format1)
        ...
        file_name = 'Detailed Lab Report.xlsx'
        return {
            'target': 'new',
