...
class AccountingReport(models.TransientModel):
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('accounting_pdf_reports.action_report_financial').with_context(company_id=self.company_id.id).report_action(self, data=data, config=False)
