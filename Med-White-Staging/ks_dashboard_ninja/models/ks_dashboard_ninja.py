...
class KsDashboardNinjaBoard(models.Model):
    ...
    # DateFilter Fields
    ks_dashboard_start_date = fields.Date(string="Start Date")
    ks_dashboard_end_date = fields.Date(string="End Date")
    ...
    def ks_fetch_dashboard_data(self, ks_dashboard_id, ks_item_domain=False):
        ...
        #     if ks_dashboard_rec.ks_child_dashboard_ids.search([['ks_active', '=', True]], limit=1):
        #         dashboard_data['ks_selected_board_id'] = str(
        #             ks_dashboard_rec.ks_child_dashboard_ids.search([['ks_active', '=', True]], limit=1).id)
        ...
        #     for rec in ks_dashboard_rec.ks_child_dashboard_ids.search_read([], ['name', 'ks_gridstack_config']):
