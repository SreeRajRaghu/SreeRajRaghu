...
class DashboardSettings(models.Model):
    ...
    def button_dummy(self):
        ...
        dashboards.write({
            # 'date_from': to_naive_utc(datetime.combine(fields.Date.today(), datetime.min.time())),
            'date_from': datetime.combine(fields.Date.today(), datetime.min.time()),
            'date_to': datetime.combine(fields.Date.today(), datetime.max.time()),
            # 'date_to': to_naive_utc(datetime.combine(fields.Date.today(), datetime.max.time())),
            'day': False,
            'month': False,
            'user_id': False,
